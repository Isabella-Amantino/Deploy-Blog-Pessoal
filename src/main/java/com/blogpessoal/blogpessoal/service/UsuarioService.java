...
public class UsuarioService {
	...
	private String criptografarSenha(String senha) {  //Vai criptografar a senha
		BCryptPasswordEncoder encoder = new BCryptPasswordEncoder();
		String senhaEncoder = encoder.encode(senha);
		return senhaEncoder;
	}
	
	private boolean compararSenhas(String senhaDigitada, String senhaBanco) {//Compara a senha que estáno Banco de Dados. Porém, só o Enconder vai conseguir fazer essa comparação
		BCryptPasswordEncoder encoder = new BCryptPasswordEncoder();
		return encoder.matches(senhaDigitada, senhaBanco);
	}
	
	private String gerarBasicToken(String email, String password) {//Gera o Token
